...
class OwnAIChat:
    ...
    def setPersonalDataTool(self):
        # print("module_cleanup_required: ", self.module_cleanup_required)
    ...
    def setupAgent(self):
        ...
        personal_data_tool = self.setPersonalDataTool()
        ...
        tools = [
            ...
            Tool(
                name="Wikipedia",
                func=wikipedia.run,
                description="useful when you need an answer about encyclopedic general knowledge but as first priority check with personal_data"
            )
        ]
        """
